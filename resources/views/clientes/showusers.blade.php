             ...
             <a a href="{{route('register')}}"> <button type="button" class="btn btn-block bg-gradient-success btn-sm" >Nuevo</button></a>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <a href="{{route('borra',  $users->id)}}" class="btn btn-danger btn-xs" onclick="return confirm('Esta Seguro de Inactivar el usuario?')"><i class="glyphicon glyphicon-pencil">borrar</i></a>
